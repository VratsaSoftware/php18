...
$read_query = "SELECT d.destination_name, c.name FROM ";
						...
						<?php while($row = mysqli_fetch_assoc($read_result)){ ?>
							<tr>
								...
								<td class="text-center">
									<a href="update.php?destinations=<?= $row['destination_id'] ?>" class="btn btn-warning">UPDATE</a>
								</td>
								<td class="text-center">
									<a href="soft_delete.php?destinations=<?= $row['destination_id'] ?>" class="btn btn-danger">SOFT DELETE</a>
								</td>
								<td class="text-center">
