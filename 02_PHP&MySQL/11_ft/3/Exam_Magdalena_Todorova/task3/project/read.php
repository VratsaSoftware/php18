...
$read_query = "SELECT h.hotel_id, h.hotel_name, h.rooms, d.destination_name FROM ";
$read_query .= "hotels h JOIN destinations d ON h.destination_id = d.destination_id ";
$read_query .= "WHERE h.date_deleted IS NULL";
